...
public class TrashcanControllerTest extends RestDocsTest {
    ...
    void trashcanListByLocation() throws Exception{
        Trashcan trashcanOne = TrashcanFixture.NORMAL.getCustomTrashcan(
                2L,
        ...
        Trashcan trashcanTwo = TrashcanFixture.RECYCLE.getCustomTrashcan(
                3L,
        ...
        given(
                trashcanQueryService.findByLocation(
